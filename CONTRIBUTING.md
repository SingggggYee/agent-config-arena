...
3. Add YAML frontmatter:
   ...
   ---
   ```
4. Run the benchmark: `npx agent-config-arena run --config configs/community/your-config-name.md`
...
4. Validate: `npx agent-config-arena validate-task tasks/community/your-task-name/`
5. Submit a PR
